...
**Update Package 4 (design):** see [`../wordpress v5/01-Update-Overview.md`](../wordpress%20v5/01-Update-Overview.md) — Step Instructions, Order Material Overuse, R&D/budget copy, Internal Products. Kickoff planning via [`../wordpress v5/07-Update-Cursor-Prompt.md`](../wordpress%20v5/07-Update-Cursor-Prompt.md) (produces `Update-4-Sprint-Plan.md`; no plugin code until a sprint is explicitly implemented).
