...
**Update Package 4:** design + plan in [`../wordpress v5/`](../wordpress%20v5/); progress in [`../wordpress v5/Update-4-Sprint-Progress.md`](../wordpress%20v5/Update-4-Sprint-Progress.md). **UP4-S1** (step instructions) done in plugin **0.24.0** / schema **1.11.0**. Next: **UP4-S2** (order material overuse + R&D copy).
